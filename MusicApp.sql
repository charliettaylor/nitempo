...
CREATE TABLE IF NOT EXISTS `musicapp`.`friend` (
  ...
  UNIQUE INDEX `friendID_UNIQUE` (`friendID` ASC) VISIBLE,
  INDEX `fk_friend_user1_idx` (`userID` ASC) VISIBLE,
  CONSTRAINT `fk_friend_user1` FOREIGN KEY (`userID`)
...
-- -----------------------------------------------------
 CREATE TABLE IF NOT EXISTS `musicapp`.`song` (
  ...
  INDEX `fk_song_user_idx_idx` (`userID` ASC) VISIBLE,
  CONSTRAINT `fk_song_user` FOREIGN KEY (`userID`)
    REFERENCES `musicapp`.`user` (`userID`)  
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
CREATE TABLE IF NOT EXISTS `musicapp`.`rating` (
  ...
  CONSTRAINT `fk_rating_song1` FOREIGN KEY (`songID`)
    REFERENCES `musicapp`.`song` (`songID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_rating_user1` FOREIGN KEY (`userID`)
    REFERENCES `musicapp`.`user` (`userID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
